            ...
            <div class="loginform">
                ...
                <form action="#" name="f" method="post">
                    ...
                    <div class="input_outer ">
                        ...
                        <input type="button" value="获取验证码" class="pass_true" id="pass_true">
                    </div>
                    <div style="text-align: center;"><span id="PhoneTip"></span></div>
                    <div class="btn">
                        <input type="button" class="act-but submit" style="color: #FFFFFF" id="submit" value="登  录">
                    </div>
                </form>
                <div class="goback">
